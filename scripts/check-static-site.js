...
const appsScriptUrl = "https://script.google.com/macros/s/AKfycbzo1xg88XWjODoMtx-B6on9D-OistzY3VaUSPK2INctqlnW8lO83hU9ipwNw2ZVz4sd/exec";
...
const requiredPageSnippets = {
  ...
  "board.html": [
    '<meta name="description" content="고유재 한옥스튜디오 공지 및 예약 현황 안내. 운영 소식, 예약 가능일 문의 동선, 접수 및 예약 확인 내역을 한곳에서 확인하세요.">',
    "목록으로 돌아가기",
    "help-close",
    "예약 확인 글입니다",
