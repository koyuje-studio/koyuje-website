...
const requiredPageSnippets = {
  "index.html": [
    ...
    "+ 가족 추가 구성 및 준비 안내",
    "가족 촬영 자녀 추가 — 실내(돌상컷) + 10만원 / 1인",
    "가족 촬영 자녀 추가 — 야외(가족컷) + 20만원 / 1인",
    "형제의 한복·신발·액세서리는 직접 준비해 주세요",
    "상품 구성 및 금액은 사전 고지 없이 변경될 수 있으며",
    "야외 가족 스냅 추가",
    'class="pkg-addon-summary"',
    'class="pkg-addon-content"',
    "원 / 1구성 · 가족 실내 앨범형 전용",
    "야외 가족 한옥스냅 또는 문화재스냅 중 원하는 구성을 선택",
    "선택한 구성당 앨범 페이지 4p 추가",
    "선택한 구성당 수정본 9장 추가",
  ],
  "guide.html": [
