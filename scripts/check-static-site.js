...
const appsScriptUrl = "https://script.google.com/macros/s/AKfycbxe69Jzk0tOCeahtmuupDYi6fee0JqULomW7cpOgO2SgHSzov1Rw5_j7iHoQaFbfNRO/exec";
...
const requiredPageSnippets = {
  ...
  "reservation.html": [
    ...
    "접수 상태는 예약 현황에서 휴대폰 번호로 확인하실 수 있습니다.",
    "입금자명과 예약 정보 확인 후",
  ...
  "status.html": [
    ...
    '<meta property="og:description" content="입금 후 작성한 예약 정보의 접수 확인중, 예약 확인 완료 상태를 확인하고 조회되지 않는 경우 카카오톡으로 문의할 수 있습니다.">',
    ...
    "입금 후 작성하셨다면 카카오톡으로 아기 이름과 촬영 예정일을 함께 알려주세요.",
  ...
  "board.html": [
    '<meta name="description" content="고유재 한옥스튜디오 예약 확인 안내. 입금 후 작성한 예약 정보는 휴대폰 번호로 확인하고, 월별 접수 현황은 간단한 숫자로 확인하세요.">',
    "Reservation Check",
    "하루 두 팀의 촬영을 차분히 준비합니다",
    "이번 달의 촬영 일정이<br>천천히 채워지고 있습니다",
    "개별 예약자 목록은 공개하지 않고",
    "휴대폰 번호 뒤 8자리",
    "function lookupReservation()",
    "function loadReservationSignal()",
    "action=reservationStats",
    "공지·예약 현황",
